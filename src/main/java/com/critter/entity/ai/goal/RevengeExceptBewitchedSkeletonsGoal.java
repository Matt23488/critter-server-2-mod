...
public class RevengeExceptBewitchedSkeletonsGoal extends TrackTargetGoal {
    ...
    public RevengeExceptBewitchedSkeletonsGoal(PathAwareEntity mob, Class<?> ... noRevengeTypes) {
        super(mob, true);
    ...
    public RevengeExceptBewitchedSkeletonsGoal setGroupRevenge(Class<?> ... noHelpTypes) {
    ...
    public boolean shouldContinue() {
        return !this.mob.hasStatusEffect(CritterMod.BEWITCHED_SKELETON) || !this.mob.getTarget().hasStatusEffect(CritterMod.BEWITCHED_SKELETON);
    }
